...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect,ASFFHead,Detect_FASFF,AFPNHead,Detect_AFPN3)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        # Build strides
        m = self.model[-1]  # Detect()
        if isinstance(m, (Detect,Detect_AFPN3)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
            s = 256  # 2x min stride
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            RepNCSPELAN4_high,
            C3k2_DynamicConv,
            C3k2_OREPA_backbone, C3k2_OREPA_neck,
            ...
            c1, c2 = ch[f], args[0]  #c1 输入通道  c2输出通道
            ...
            c2 = sum(ch[x] for x in f)
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect,ASFFHead,Detect_FASFF,AFPNHead,Detect_AFPN3}:
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect, WorldDetect, v10Detect,ASFFHead,Detect_FASFF,AFPNHead,Detect_AFPN3)):
                return "detect"
